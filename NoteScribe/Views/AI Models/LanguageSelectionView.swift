...
struct LanguageSelectionView: View {
    ...
    private func updateLanguage(_ language: String) {
        ...
        // OFFLINE MODE: Removed transcriptionPrompt.updateTranscriptionPrompt() call
    ...
    private func languageSelectionDisabled() -> Bool {
        guard let provider = transcriptionState.currentTranscriptionModel?.provider else {
            return false
        }
    ...
    private var languageSelectionSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            if let currentModel = transcriptionState.currentTranscriptionModel
            {
