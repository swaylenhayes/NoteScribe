...
class LastTranscriptionService: ObservableObject {
    ...
    static func retryLastTranscription(from modelContext: ModelContext, transcriptionState: TranscriptionState) {
        Task { @MainActor in
            ...
            let transcriptionService = AudioTranscriptionService(modelContext: modelContext, transcriptionState: transcriptionState)
            do {
