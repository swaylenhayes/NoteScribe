...
// OFFLINE MODE: Only local model providers, cloud providers disabled
enum ModelProvider: String, Codable, Hashable, CaseIterable {
    case local = "Local"
    case parakeet = "Parakeet"

    // DISABLED IN OFFLINE MODE - Kept for potential re-enabling
...
// Parakeet models (FluidAudio - Local CoreML)
...
// DISABLED IN OFFLINE MODE - Cloud models kept for potential re-enabling
#if ENABLE_CLOUD_TRANSCRIPTION
...
struct LocalModel: TranscriptionModel {
    ...
    var downloadURL: String {
        "https://huggingface.co/ggerganov/transcription engine/resolve/main/\(filename)"
    }
