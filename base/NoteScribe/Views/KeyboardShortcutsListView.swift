    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Quick reference for all NoteScribe shortcuts")
            ...
            ScrollView {
                LazyVGrid(columns: [
                    ...
                    ShortcutCard(
                        ...
                        subtitle: "Paste the most recent transcription"
                    ) {
...
#Preview {
    KeyboardShortcutsListView()
        .environmentObject(HotkeyManager(transcriptionState: TranscriptionState(modelContext: try! ModelContext(ModelContainer(for: Transcription.self)))))
}
